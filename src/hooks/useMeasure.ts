...
export function useMeasure<E extends HTMLElement>(ref: React.RefObject<E | undefined>, options?: UseMeasureOptions): Size
...
export function useMeasure(...args: any[]) {
  const ownRef = useRef<HTMLElement | undefined>(undefined)
